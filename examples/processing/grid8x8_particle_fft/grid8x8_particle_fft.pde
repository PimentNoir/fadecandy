  ...
  for (int i = 0; i < fftFilterLenght; i++) {
    ...
    switch(reactivity_type) {
      case 0:
        ...
        float low_noise_fft = simplexnoise_fbm(now * spin + noise_scale_fft * fftFilterNorm[i] * noise_fft * fftFilterNormVar, noise_scale_fft * fftFilterNorm[i] * noise_fft * fftFilterNormVar + noise_scale_fft * pulse_type, octaves, (float)1/octaves, 0.5f);
