...
void setup()
{
  ...
  //opc.ledGrid8x8(5 * 64, width * 5/8, height * 1/4, height/16, 0, false);
  //opc.ledGrid8x8(6 * 64, width * 3/8, height * 3/4, height/16, 0, false);
  //opc.ledGrid8x8(7 * 64, width * 5/8, height * 3/4, height/16, 0, false);
  opc.ledGrid16x16(1 * 64, width * 5/8, height * 2/4, height/32, 0, true);
